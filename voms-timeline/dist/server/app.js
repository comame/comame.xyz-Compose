...
/***/ "./src/API/YouTubeApiOptions/SearchAPIOptions.ts":
/*!*******************************************************!*\
  !*** ./src/API/YouTubeApiOptions/SearchAPIOptions.ts ***!
  \*******************************************************/
...
app.all('/sub/hook', async (req, res) => {
    ...
    if (!videoId)
        return;
    const videos = await fetchVideo_1.fetchVideo([videoId]);
    if ((videos === null || videos === void 0 ? void 0 : videos.length) == 0 || typeof videos == 'undefined')
        return;
    await cache_1.cacheResponse(db, videos);
});
...
app.get('/api/videos', async (req, res) => {
    const { videos, lastUpdated, lastFetch } = await cache_1.getCached(db);
    res.send({
    ...
    if (Date.now() - 24 * 60 * 60 * 1000 / 5 >= lastFetch) {
        ...
        const videos = await fetchVideo_1.fetchVideo(videoIds);
        if ((videos === null || videos === void 0 ? void 0 : videos.length) == 0 || typeof videos == 'undefined')
            return;
        await cache_1.cacheResponse(db, videos, Date.now());
    }
});
...
async function cacheResponse(db, videos, lastFetch) {
...
async function getCached(db, limit = 50) {
    ...
    const lastUpdated = (_a = cacheMetadata === null || cacheMetadata === void 0 ? void 0 : cacheMetadata.lastUpdated) !== null && _a !== void 0 ? _a : 0;
    const lastFetch = (_b = cacheMetadata === null || cacheMetadata === void 0 ? void 0 : cacheMetadata.lastFetch) !== null && _b !== void 0 ? _b : 0;
...
const SearchAPIOptions_1 = __webpack_require__(/*! ../API/YouTubeApiOptions/SearchAPIOptions */ "./src/API/YouTubeApiOptions/SearchAPIOptions.ts");
